...
- Настройте работу общего кода с андроид приложением - чтобы из андроида был доступ к вьюмоделям
- Добавьте необходимые фрагменты в Android-приложение, фрагменты наследуйте от `MvvmFragment` из `moko-mvvm`, также копируйте из уже готового приложения 3 блока, должно норм связаться
- перенесите классы из iOS приложения 3 блока в новое приложение, свяжите с вьюмоделью, но без координаторов
