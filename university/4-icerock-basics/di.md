...
- Настройте работу общего кода с Android-приложением - чтобы на Android стороне была уже работа с вьюмоделями (тут сомнения, что все это сразу заработает)
...
- Перенесите классы из iOS приложения 3 блока в новое приложение
- Android приложение должно работать как работало (за исключением некоторых моментов(строки локализации в общем коде и тд, главное чтобы список работал +-))
- iOS приложение должно запускаться (?)
- ***тут надо еще подумать, как-то много и сложно получается***
