...
// Дописать тут вступительные слова, что в первом разделе вы создадите новый проект по нашему шаблону, а во всех остальных разделах будете переписывать текущую реализацию используя наши подходы
