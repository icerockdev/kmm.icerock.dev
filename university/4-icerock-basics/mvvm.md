...
- Подключите библиотеку moko-mvvm в ваш проект
- Добавьте в ваши фичи необходимые вьюмодели (ориентируясь на вьюмодели из предыдущей практики), все вьюмодели наследуйте от `ViewModel` из `moko-mvvm`, просто перетащите вьюмодели и все им необходимое, чтобы код компилися (надо может диаграмму классов воткнуть сюда, чтобы сразу ориентироваться могли)
  - вьюмодели для фичич авторизации
  - вьюмодели для фичи списка репозиториев
  - вьмюодели для фичи детальной информации о репозитории
