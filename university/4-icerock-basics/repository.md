...
Эта практика не связана с текущим приложением, выполняйте ее в отдельном проекте, созданном по [инструкции](https://kotlinlang.org/docs/multiplatform-mobile-create-first-app.html).
