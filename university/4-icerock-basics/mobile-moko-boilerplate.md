...
Номера сборки должны быть сквозные для всех платформ. 
...
1. Выполните первые два пункта из CodeLab [IceRock KMP onboarding #1](https://codelabs.kmp.icerock.dev/codelabs/kmm-icerock-onboarding-1-ru/index.html), чтобы правильно настроить рабочее окружение
...
4. Выполните пункты из CodeLab [IceRock KMP onboarding #1](https://codelabs.kmp.icerock.dev/codelabs/kmm-icerock-onboarding-1-ru/index.html), начиная с четвертого, но уже в проекте, созданном на прошлом шаге
