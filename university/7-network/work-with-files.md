...
Первый вариант, хоть он и проще в реализации, можно использовать только если файл небольшой - до 5 МВ, если файл будет больше - то велика вероятность, что памяти на устройстве не хватит.
