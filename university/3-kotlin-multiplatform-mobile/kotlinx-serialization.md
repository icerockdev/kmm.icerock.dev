...
Кодлаба выходила в 2021 году, поэтому при открытии starter project могут потребоваться обновления:
поднять версию Gradle, AGP, Compile SDK и Java до актуальных (рекомендации Android Studio).
