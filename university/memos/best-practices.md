...
2. Обрабатывайте стейты на iOS [правильно](../../learning/state#обработка-на-ios) 
...
## Android
### Logic
1. Обрабатывайте стейты на Android [правильно](../../learning/state#обработка-на-android)
