...
- [KOTLIN MULTIPLATFORM IN PRODUCTION: Key takeaways from developing two cross-platform apps](https://www.droidcon.com/2021/11/10/kotlin-multiplatform-mobile-in-production-key-takeaways-from-developing-two-cross-platform-apps/)
- [Introduction to Kotlin Multiplatform and D-KMP](https://youtu.be/QqR1FNM2M7k)
- [Kotlin For Everything](https://youtu.be/WMRFMPwwUuo?t=4548)
- [Is Kotlin Multiplatform Ready for Production?](https://youtu.be/L8Xq15NTuCc)
- [KMP плагин под капотом](https://www.youtube.com/watch?v=2YZnpTLsrQ4)
...
- [Kotlin Multiplatform: Real World Lessons Learned](https://youtu.be/qcwFizHMV4Y)
...
- [Three-framework problem with Kotlin Multiplatform](https://medium.com/xorum-io/three-framework-problem-with-kotlin-multiplatform-mobile-16267c5afa53)
- [KMP Oddity #1: Interface methods with underscores](https://medium.com/xorum-io/kmm-oddity-1-interface-methods-with-underscores-21523b8ed797)
- [KMP Oddity #2: Initialization order of top-level properties](https://medium.com/xorum-io/kmm-oddity-2-initialization-order-of-top-level-properties-edd11ec350a2)
...
- [Building a Kotlin Multiplatform Proof of Concept Conclusions](https://akjaw.com/kotlin-multiplatform-mobile-poc-conclusions/)
- [Using different Kotlin versions in a KMP project](https://johnoreilly.dev/posts/kmm-using-different-kotlin-versions/)
...
- [Getting started with Kotlin Multiplatform (KMP)](https://medium.com/@bitrise/getting-started-with-kotlin-multiplatform-mobile-kmm-23d02c21d0b9)
...
- [Guide: Creating a CocoaPod using Kotlin Multiplatform library](https://www.elements.nl/en-blog/guide-creating-a-cocoapod-using-kotlin-multiplatform-mobile-library)
...
- [IS KMP production-ready? How we migrated our code to Kotlin Multiplatform! Part 1](https://medium.com/mounty-engineering/is-kmm-production-ready-how-we-migrated-our-code-to-kotlin-multiplatform-mobile-part-1-d7329874a402)
- [Move android code to KMP Shared Module| How we migrated our code to Kotlin Multiplatform! Part 2](https://medium.com/mounty-engineering/move-android-code-to-kmm-shared-module-how-we-migrated-our-code-to-kotlin-multiplatform-mobile-e86d70e17a81)
- [Networking in KMP (KTOR) Part-3](https://medium.com/mounty-engineering/networking-in-kmm-ktor-part-3-78ec68787f6a)
- [LocalDb in KMP (SQLDelight) Part-4](https://medium.com/mounty-engineering/localdb-in-kmm-sqldelight-part-4-573ea0904156)
...
- [Understanding and Configuring your Kotlin Multiplatform Test Suite](https://touchlab.co/understanding-and-configuring-your-kmm-test-suite/)
...
- [Using SwiftUI with View Model written in Kotlin Multiplatform](https://lwesterhoff.medium.com/using-swiftui-with-view-model-written-in-kotlin-multiplatform-mobile-67cf7b6da551)
- [The journey of Lunabee Studio with KMP](https://medium.com/@anthony.couhier/the-journey-of-lunabee-studio-with-kmm-66895316959e) - графики сравнения Native и KMP
- [Create a Kotlin/Multiplatform library with Swift](https://medium.com/kodein-koders/create-a-kotlin-multiplatform-library-with-swift-1a818b2dc1b0) - интеграция static swift library в kmp библиотеку
...
- [Why iOS Engineers Should Avoid This Glorified KMP Technique](https://artandscienceofcoding.com/science/avoid-this-kmm-technique/)
...
- [Zero To Hero in KMP with Compose and SwiftUi](https://proandroiddev.com/zero-to-hero-in-kmm-with-compose-and-swiftui-d8951f7d80b7)
- [Public key pinning using Ktor for Android and iOS (KMP)](https://medium.com/@MrHardikTrivedi/public-key-pinning-using-ktor-for-android-and-ios-kmm-61066cb34321)
