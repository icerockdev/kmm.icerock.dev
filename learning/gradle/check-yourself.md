...
Результатом выполнения следующих задач должен быть репозиторий на https://github.com или 
...
2. Вынести зависимости (moko-mvvm и другие подключенные, если есть) в Deps объект внутри buildSrc
3. Там же завести Modules объект с указанием путей до всех модулей
