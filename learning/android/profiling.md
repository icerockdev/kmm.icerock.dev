...
Следовательно много времени используется для создания и обновления списков(**голубой цвет**), возможно много кастомных 
вью или много работы методов onDraw. Много временить тратится на обратку методов onLayout 
и onMeasure(**светло зеленый**), может быть отрисовывается сложная иерархия вью. Так же много времени 
уходит на аниматоры, которые выполняются для вью, и на обработку входных коллбэки(**темно зеленый**), биндинги во время скроллинга,
