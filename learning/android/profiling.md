...
цветов. Следовательно нужно уделить внимание загрузке растровой информации(голубой цвет), отрисовке
лэйаутов(светло зеленый) и элементам с переиспользованием(темно зеленый).
...
Судя по результатам, опитимизировать еще есть куда.