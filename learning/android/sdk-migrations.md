...
**Notification cooldown** — при массовом поступлении уведомлений система автоматически снижает громкость и приоритет на до 2 минут (кроме звонков и будильников). | Учитывать при тестировании массовых push-уведомлений. https://developer.android.com/about/versions/16/features#notification-cooldown
...
**App archiving** — OS-уровневая поддержка архивирования/разархивирования приложений, включая сторонние сторы. Архивированные приложения освобождают место, но сохраняют данные. | Поддержать восстановление состояния после unarchive, проверить корректность работы после reinstall. https://developer.android.com/about/versions/15/behavior-changes-15#app-archiving
...
Изменения | Что делать? (миграция)
------------ | -------------
**Блокировка старых приложений** — Android 14 блокирует установку приложений, targeting ниже Android 6.0 (API 23). Обойти можно только через ADB флаг. | Убедиться что `targetSdkVersion` >= 23 (для sideloading). Google Play уже требует более высокий targetSdk. https://developer.android.com/about/versions/14/behavior-changes-14#minimum-target-api-level
