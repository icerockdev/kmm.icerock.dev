...
MOKO — это наши мультиплатформенные open-source библиотеки. Они делают работу над проектами проще, а задачи — понятнее. Поскольку все проекты строятся на них, нужно познакомиться с MOKO поближе.
