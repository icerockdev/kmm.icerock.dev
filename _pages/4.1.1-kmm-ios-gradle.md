...
dependencies {
    ...
    // подключение зависимости к common коду, транзитивно (api). Это означает что классы данной зависимости будут видны вне вне данного модуля при подключении нашего модуля.
